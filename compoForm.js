...
let padding = {paddingRight:"15px"};
    return (
        <form className="form-group container-fluid m-3" style={{fontSize: "16px", paddingLeft: '20px'}} onSubmit={handleSubmit}>
            ...
            <tr>
                ...
                <td>
               {/* <button class="btn btn-success btn-outline-dark text-white m-3" >Img Preview</button> */}
                </td>
            </tr>
            <tr>
                <button class="btn btn-primary m-3 btn-outline-dark text-white" type="submit">Enregister</button>
                <button class="btn btn-info m-3 btn-outline-dark" onClick={reset}  type="reset">Reset</button>
            </tr>
        </form>
